...
## ArchetypeQuery<T1,T2,T3,T4,T5>.AnyTags(Tags) Method

A query result will contain only entities having any of the the passed [tags](ArchetypeQuery_T1,T2,T3,T4,T5_.AnyTags(Tags).md#Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4,T5_.AnyTags(Friflo.Engine.ECS.Tags).tags 'Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4,T5>.AnyTags(Friflo.Engine.ECS.Tags).tags').

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4,T5> AnyTags(in Friflo.Engine.ECS.Tags tags);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4,T5_.AnyTags(Friflo.Engine.ECS.Tags).tags'></a>
