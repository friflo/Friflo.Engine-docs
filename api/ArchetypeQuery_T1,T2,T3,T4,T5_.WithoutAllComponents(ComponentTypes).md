...
## ArchetypeQuery<T1,T2,T3,T4,T5>.WithoutAllComponents(ComponentTypes) Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4,T5> WithoutAllComponents(in Friflo.Engine.ECS.ComponentTypes componentTypes);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4,T5_.WithoutAllComponents(Friflo.Engine.ECS.ComponentTypes).componentTypes'></a>
