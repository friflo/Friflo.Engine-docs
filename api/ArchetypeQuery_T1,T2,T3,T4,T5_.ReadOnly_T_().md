...
## ArchetypeQuery<T1,T2,T3,T4,T5>.ReadOnly<T>() Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4,T5> ReadOnly<T>()
    where T : struct, Friflo.Engine.ECS.IComponent, System.ValueType, System.ValueType;
```
#### Type parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4,T5_.ReadOnly_T_().T'></a>
