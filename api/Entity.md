...
- <b>scripts</b><br/>[Scripts](Entity.Scripts.md 'Friflo.Engine.ECS.Entity.Scripts')<br/>[GetScript&lt;T&gt;()](Entity.GetScript_T_().md 'Friflo.Engine.ECS.Entity.GetScript<T>()')<br/>[TryGetScript&lt;T&gt;(T)](Entity.TryGetScript_T_(T).md 'Friflo.Engine.ECS.Entity.TryGetScript<T>(T)')<br/>[AddScript&lt;TScript&gt;(TScript)](Entity.AddScript_TScript_(TScript).md 'Friflo.Engine.ECS.Entity.AddScript<TScript>(TScript)')<br/>[RemoveScript&lt;T&gt;()](Entity.RemoveScript_T_().md 'Friflo.Engine.ECS.Entity.RemoveScript<T>()')<br/>
...
| [AddComponent&lt;T&gt;()](Entity.AddComponent_T_().md 'Friflo.Engine.ECS.Entity.AddComponent<T>()') | Add a component of the given type to the entity. |
| [AddComponent&lt;T&gt;(T)](Entity.AddComponent_T_(T).md 'Friflo.Engine.ECS.Entity.AddComponent<T>(T)') | Add the given [component](Entity.AddComponent_T_(T).md#Friflo.Engine.ECS.Entity.AddComponent_T_(T).component 'Friflo.Engine.ECS.Entity.AddComponent<T>(T).component') to the entity. |
| [AddScript&lt;TScript&gt;(TScript)](Entity.AddScript_TScript_(TScript).md 'Friflo.Engine.ECS.Entity.AddScript<TScript>(TScript)') | Add the given [script](Entity.AddScript_TScript_(TScript).md#Friflo.Engine.ECS.Entity.AddScript_TScript_(TScript).script 'Friflo.Engine.ECS.Entity.AddScript<TScript>(TScript).script') to the entity. |
...
| [GetScript&lt;T&gt;()](Entity.GetScript_T_().md 'Friflo.Engine.ECS.Entity.GetScript<T>()') | Returns the [Script](Script.md 'Friflo.Engine.ECS.Script') of Type [T](Entity.GetScript_T_().md#Friflo.Engine.ECS.Entity.GetScript_T_().T 'Friflo.Engine.ECS.Entity.GetScript<T>().T'). Otherwise null |
...
| [RemoveScript&lt;T&gt;()](Entity.RemoveScript_T_().md 'Friflo.Engine.ECS.Entity.RemoveScript<T>()') | Remove the script with the given type from the entity. |
...
| [TryGetScript&lt;T&gt;(T)](Entity.TryGetScript_T_(T).md 'Friflo.Engine.ECS.Entity.TryGetScript<T>(T)') | |
