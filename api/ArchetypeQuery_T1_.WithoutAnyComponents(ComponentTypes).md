...
## ArchetypeQuery<T1>.WithoutAnyComponents(ComponentTypes) Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1> WithoutAnyComponents(in Friflo.Engine.ECS.ComponentTypes componentTypes);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1_.WithoutAnyComponents(Friflo.Engine.ECS.ComponentTypes).componentTypes'></a>
