...
## ArchetypeQuery<T1,T2,T3>.WithoutAnyTags(Tags) Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3> WithoutAnyTags(in Friflo.Engine.ECS.Tags tags);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3_.WithoutAnyTags(Friflo.Engine.ECS.Tags).tags'></a>
