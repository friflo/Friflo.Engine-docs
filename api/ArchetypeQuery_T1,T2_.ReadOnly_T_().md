...
## ArchetypeQuery<T1,T2>.ReadOnly<T>() Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2> ReadOnly<T>()
    where T : struct, Friflo.Engine.ECS.IComponent, System.ValueType, System.ValueType;
```
#### Type parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2_.ReadOnly_T_().T'></a>
