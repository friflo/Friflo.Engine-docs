...
| [ToEntityList()](ArchetypeQuery.ToEntityList().md 'Friflo.Engine.ECS.ArchetypeQuery.ToEntityList()') | Returns the query result as an [EntityList](EntityList.md 'Friflo.Engine.ECS.EntityList') to perform structural changes. |
