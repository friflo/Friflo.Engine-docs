...
## ArchetypeQuery<T1,T2,T3,T4>.AllTags(Tags) Method

A query result will contain only entities having all passed [tags](ArchetypeQuery_T1,T2,T3,T4_.AllTags(Tags).md#Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4_.AllTags(Friflo.Engine.ECS.Tags).tags 'Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4>.AllTags(Friflo.Engine.ECS.Tags).tags').

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4> AllTags(in Friflo.Engine.ECS.Tags tags);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4_.AllTags(Friflo.Engine.ECS.Tags).tags'></a>
