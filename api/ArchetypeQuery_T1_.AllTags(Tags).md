...
## ArchetypeQuery<T1>.AllTags(Tags) Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1> AllTags(in Friflo.Engine.ECS.Tags tags);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1_.AllTags(Friflo.Engine.ECS.Tags).tags'></a>
