...
## ArchetypeQuery<T1,T2,T3,T4>.AllComponents(ComponentTypes) Method

```csharp
public Friflo.Engine.ECS.ArchetypeQuery<T1,T2,T3,T4> AllComponents(in Friflo.Engine.ECS.ComponentTypes componentTypes);
```
#### Parameters

<a name='Friflo.Engine.ECS.ArchetypeQuery_T1,T2,T3,T4_.AllComponents(Friflo.Engine.ECS.ComponentTypes).componentTypes'></a>
